...
ただし、マモチャレというからには、ただの買い物ではありません。
「制限時間内に、リストにある商品をどれだけ多く買い物することができるか？買い物ができた数に応じて、より多くのポイントを獲得できる」というチャレンジです。
...
タイム管理はiPadのストップウォッチを起動させて実施してください。タイム終了となったら、自分でチャレンジを終了させてください。

また、チャレンジ終了時にリストの買い物品を手に持っている場合は、お会計を済ませてください（タイム終了時にお会計が終了していなければポイント加算はされませんが、お店に迷惑がかからないよう、お買い上げしてもらいます）。`,
